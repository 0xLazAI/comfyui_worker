...
export function buildBlenderScriptPrompt(
  ...
  return [
    ...
    '- If a human or humanoid actor is present, torso, pelvis, head, arms, hands, legs, and feet must read as one continuous connected body.',
    '- Never create floating, detached, or separated limbs; arms must connect through shoulder/upper arm/elbow/forearm/hand and legs through hip/thigh/knee/shin/foot.',
